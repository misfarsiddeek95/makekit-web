<footer class="main-footer style-two">
        ...
        <div class="widgets-section">
            ...
            <div class="big-column col-lg-5 col-md-12 col-sm-12">
                ...
                <div class="newsletter-box">
                    <form method="post" id="home_news_letter">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            autocomplete="off"
                        />
                        <input type="hidden" name="g_recaptcha_response" id="home_news_letter-g-recaptcha-response">
                        <button
                            type="submit"
    ...
    <div class="footer-bottom">
        ...
        <div class="inner-container d-flex justify-content-center">
            ...
            &copy; <?=date('Y')?> <a href="<?=base_url()?>">Arbol Soft.</a> All rights
            reserved.
            </div>
        </div>
        </div>
