                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-center gap-4 text-center">
                        ...
                        <div class="feature-icon mb-4 mb-md-0 w-15">
                            ...
                            <h4 style="--icon-text-color: var(--dingy-dungeon);">כתובת</h4>
                            <p>דוד ילין 9, גאולה,<br>ירושלים</p>
                        </div>
                        <div class="feature-icon mb-4 mb-md-0 w-15">
                            ...
                            <h4 style="--icon-text-color: var(--royal-orange);">טלפון</h4>
                            <p>02-566-0078</p>
                        </div>
                        <div class="feature-icon mb-4 mb-md-0 w-15">
                            ...
                            <h4 style="--icon-text-color: var(--crayolas-maize);">ווטסאפ</h4>
                            <p>058-770-3017</p>
                        </div>
                        <div class="feature-icon mb-4 mb-md-0">
                            ...
                            <h4 style="--icon-text-color: var(--light-sea-green);">דוא"ל</h4>
                            <p>support@makekit.co.il</p>
                        </div>
                    </div>
                </div>
            </section>
